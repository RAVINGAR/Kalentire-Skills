            ...
            if (defenderHero.hasEffect("ShieldReflect")) {
                ...
                switch (defenderPlayer.getItemInHand().getType()) {
                    ...
                    case TRAP_DOOR:
                        ...
                        Skill.damageEntity(attackerCT.getEntity(), defenderLE, damage, DamageCause.MAGIC, false);
                    default:
                        return;
                }
            }
                ...
                if (defenderHero.hasEffect("ShieldReflect")) {
                    ...
                    switch (defenderHero.getPlayer().getItemInHand().getType()) {
                        ...
                        case TRAP_DOOR:
                            ...
                            Skill.damageEntity((LivingEntity) attacker, (LivingEntity) defender, damage, DamageCause.MAGIC, false);
                        default:
                            return;
                    }
                }
