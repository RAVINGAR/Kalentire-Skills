...
public class SkillDivineStun extends TargettedSkill {
    ...
    public SkillDivineStun(Heroes plugin) {
        ...
        setTypes(SkillType.ABILITY_PROPERTY_MAGICAL, SkillType.ABILITY_PROPERTY_LIGHT, SkillType.SILENCEABLE, SkillType.DISABLING, SkillType.DAMAGING, SkillType.AGGRESSIVE, SkillType.INTERRUPTING);
    }
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        hero.getPlayer().getWorld().playSound(hero.getPlayer().getLocation(), Sound.ENTITY_ENDERMEN_TELEPORT, 0.5F, 1.0F);
