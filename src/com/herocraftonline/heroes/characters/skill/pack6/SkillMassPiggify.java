...
public class SkillMassPiggify extends ActiveSkill {
    ...
    public SkillResult use(Hero hero, String[] args) {
        ...
        player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PIG_DEATH.value(), 0.8F, 1.0F);
        player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PIG_AMBIENT.value(), 0.8F, 1.0F);
