...
// this skill was missing for some reason from this pack, maybe because I had to update its particle and sound? (and fully uncomment it)
...
public class SkillIre extends TargettedSkill {
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        target.getWorld().spawnParticle(Particle.BLOCK_CRACK, target.getEyeLocation(),75,0.2F,0.2F,0.2F,0.1F, Bukkit.createBlockData(Material.DIRT));
