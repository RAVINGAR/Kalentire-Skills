...
public class SkillDragonSmash extends ActiveSkill implements Listener {
    ...
    public SkillResult use(final Hero hero, String[] args) {
        ...
        player.playSound(player.getLocation(), Sound.ENTITY_FIREWORK_LAUNCH.value(), 2, 1);
    ...
    private void playBoomEffect(final Hero hero) {
        ...
        loc.getWorld().playSound(loc, Sound.ENTITY_GENERIC_EXPLODE.value(), 2, 1);
        new BukkitRunnable() {
            int i = 1;
...
//                                && b.getType() != Material.STATIONARY_LAVA
    ...
    public void onBlockChangeState(EntityChangeBlockEvent event) {
        if (fallingBlocks.contains(event.getEntity())) {
            ...
            fb.getWorld().playSound(fb.getLocation(), Sound.BLOCK_STONE_STEP.value(), 1, 1);
