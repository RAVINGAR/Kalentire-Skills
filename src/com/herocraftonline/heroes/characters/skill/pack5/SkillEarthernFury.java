...
public class SkillEarthernFury extends TargettedSkill {
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        player.getWorld().playSound(player.getLocation(), Sound.BLOCK_GRASS_HIT.value(), 1.0F, 1.0F);
        ...
        private void setEffect(LivingEntity entity) {
            ...
            effect = new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    fEntity.getWorld().playSound(location, Sound.BLOCK_GRAVEL_HIT.value(), 0.1F, 1.0F);
