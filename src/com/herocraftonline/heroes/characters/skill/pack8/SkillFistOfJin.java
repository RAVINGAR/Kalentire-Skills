...
public class SkillFistOfJin extends PassiveSkill {
    ...
    public SkillFistOfJin(Heroes plugin) {
        ...
        setDescription("Passive: Each of your melee strikes restore $1 health to you, and $2 health to party members within $3 blocks. You cannot heal more than once per $4 second(s).");
