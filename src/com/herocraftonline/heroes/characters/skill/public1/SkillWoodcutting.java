...
public class SkillWoodcutting extends PassiveSkill {
    ...
    public class SkillBlockListener implements Listener {
        ...
        public void onBlockBreak(BlockBreakEvent event) {
            ...
            if (!hero.hasEffect("Woodcutting") || (Util.nextRand() > (SkillConfigManager.getUseSetting(hero, this.skill, SkillSetting.CHANCE_LEVEL, .001, false) * hero.getSkillLevel(this.skill)))) {
                return;
            }
