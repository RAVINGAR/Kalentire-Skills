...
public class SkillInversion extends TargettedSkill {
    ...
    public String getDescription(Hero hero) {
        ...
        damageMod += (SkillConfigManager.getUseSetting(hero, this, "damage-modifier-increase", 0.0, false) * hero.getSkillLevel(this));
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        final double damageMod = SkillConfigManager.getUseSetting(hero, this, "damage-modifier", 1.0, false) + (SkillConfigManager.getUseSetting(hero, this, "damage-modifier-increase", 0.0, false) * hero.getSkillLevel(this));
