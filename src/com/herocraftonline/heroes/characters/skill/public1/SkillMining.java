...
public class SkillMining extends PassiveSkill {
    ...
    public class SkillBlockListener implements Listener {
        ...
        public void onBlockBreak(BlockBreakEvent event) {
            ...
            if (isStone && chance <= SkillConfigManager.getUseSetting(hero, skill, "chance-from-stone", .0005, false) * hero.getLevel(skill)) {
            ...
            if (chance > SkillConfigManager.getUseSetting(hero, skill, SkillSetting.CHANCE_PER_LEVEL, .001, false) * hero.getLevel(skill)) {
                return;
            }
