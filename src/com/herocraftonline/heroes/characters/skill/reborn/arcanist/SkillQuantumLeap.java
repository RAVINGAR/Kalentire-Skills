...
public class SkillQuantumLeap extends TargettedSkill {
    public SkillQuantumLeap(Heroes plugin) {
        ...
        setDescription("Open a rift in space between you and your target, causing both of you to switch places.");
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        if (targetHero.hasEffectType(EffectType.STUN) || targetHero.hasEffectType(EffectType.DISABLE))
            return SkillResult.INVALID_TARGET;
