...
//        int manaP
//        double manaMulti = SkillConfigManager.getUseSetting(hero, this, "mana-conversion-multiplier", 0.75, false);
//
//        String formattedDamage = Util.decFormat.format(damage);
//        String formattedHeal = Util.decFormat.format(damage * manaMulti);
//
...
//        node.set("mana-tick-period", 500);
//        node.set("mana-conversion-multiplier", 0.75);
//
//        return node;
//    }
//
