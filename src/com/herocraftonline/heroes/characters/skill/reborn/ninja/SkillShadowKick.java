...
public class SkillShadowKick extends TargettedSkill {

    public SkillShadowKick(Heroes plugin) {
        super(plugin, "ShadowKick");
        setDescription("Phase into the shadows and reappear behind your target, following up with a silencing Kick! " +
                "The target will be dealt $1 damage and be silenced for $2 second(s).");
        setUsage("/skill shadowkick");
        setIdentifiers("skill shadowkick");
        setArgumentRange(0, 0);
        setTypes(SkillType.ABILITY_PROPERTY_DARK, SkillType.NO_SELF_TARGETTING, SkillType.DAMAGING, SkillType.AGGRESSIVE,
                SkillType.TELEPORTING, SkillType.SILENCEABLE, SkillType.STEALTHY);
    }
    ...
    public ConfigurationSection getDefaultConfig() {
        ...
        config.set(SkillSetting.USE_TEXT.node(), ChatComponents.GENERIC_SKILL + "%hero% appeared behind %target% and kicked!");
        return config;
    }
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        targetCT.addEffect(new SilenceEffect(this, player, duration));
