...
//        projectile.setYield(0.0F);
    ...
    private void explodeSnowballIntoAoEEffect(Snowball projectile) {
        ...
        EnderFlameAoEEffect groundEffect = new EnderFlameAoEEffect(damageTick, radius, height, locationsInCircle);
    ...
    private class EnderFlameAoEEffect implements GroundEffectActions {
        ...
        EnderFlameAoEEffect(double damageTick, int radius, int height, List<Location> locationsInRadius) {
