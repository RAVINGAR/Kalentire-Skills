...
public class SkillMaim extends TargettedSkill {
    ...
    public SkillMaim(Heroes plugin) {
        super(plugin, "Maim");
        setDescription("You Maim your target with your axe, dealing $1 physical damage, interrupting abilities and slowing for $2 second(s).");
        setUsage("/skill maim");
    ...
    public ConfigurationSection getDefaultConfig() {
        ...
        config.set("weapons", Util.weapons);
        config.set("amplitude", 3);
        ...
        config.set(SkillSetting.APPLY_TEXT.node(), ChatComponents.GENERIC_SKILL + "%target% has been maimed by %hero%!");
    ...
    public void init() {
        ...
        applyText = SkillConfigManager.getRaw(this, SkillSetting.APPLY_TEXT, ChatComponents.GENERIC_SKILL + "%target% has been maimed by %hero%!")
                .replace("%target%", "$1")
                .replace("%hero%", "$2");
