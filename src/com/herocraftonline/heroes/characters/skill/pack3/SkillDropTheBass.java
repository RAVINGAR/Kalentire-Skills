...
public class SkillDropTheBass extends ActiveSkill {
    ...
    public SkillDropTheBass(Heroes plugin) {
        ...
        skillSong = new Song(
                ...
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.8F, 5.0F, 1),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.8F, 4.0F, 2),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.8F, 3.0F, 3),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.8F, 2.0F, 4),
                new Note(Sound.BLOCK_NOTE_BASS.value(), 0.8F, 1.0F, 5),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.0F, 1.0F, 6),
                new Note(Sound.BLOCK_NOTE_BASS.value(), 0.8F, 0.0F, 7),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.0F, 1.0F, 8),
                new Note(Sound.BLOCK_NOTE_HARP.value(), 0.8F, 3.0F, 9)
        );
    }
