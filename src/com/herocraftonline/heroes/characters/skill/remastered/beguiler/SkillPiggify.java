...
public class SkillPiggify extends TargettedSkill {
    ...
    public SkillPiggify(Heroes plugin) {
        ...
        setDescription("You force your target to ride a pig for $1 second(s).");
...
//        player.getWorld().playSound(player.getLocation(), Sound.ENTITY_ZOMBIE_PIGMAN_HURT, 0.8F, 1.0F);
        player.getWorld().playSound(player.getLocation(), Sound.ENTITY_ZOMBIFIED_PIGLIN_HURT, 0.8F, 1.0F);
