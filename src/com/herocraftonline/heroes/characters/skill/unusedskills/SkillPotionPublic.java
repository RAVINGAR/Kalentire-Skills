...
public class SkillPotionPublic extends PassiveSkill {
    ...
    public class PotionListener implements Listener {
        ...
        public void onPlayerInteract(PlayerInteractEvent event) {
            ...
            final Hero hero = SkillPotionPublic.this.plugin.getCharacterManager().getHero(player);
