...
import com.herocraftonline.heroes.nms.versions.EntityUtil_v1_8_R2;
...
public class SkillPyromancy extends ActiveSkill implements Listener {
    ...
    public SkillPyromancy(final Heroes plugin) {
        ...
        plugin.getServer().getScheduler().runTask(plugin, new Runnable() {
            ...
            @Override
            public void run() {
                EntityUtil_v1_8_R2.registerCustomEntity(PyromancyBlaze.class, "SkillPyromancyBlaze", 61, false);
                EntityUtil_v1_8_R2.registerCustomEntity(PyromancyBlazeFireball.class, "SkillPyromancyFireball", 12, false);
            }
