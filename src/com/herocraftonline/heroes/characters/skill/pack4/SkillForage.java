...
public class SkillForage extends ActiveSkill {
    ...
    public SkillResult use(Hero hero, String[] args) {
        ...
        case ICE_MOUNTAINS:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "ice.chance", .01, false) * hero.getLevel(this);
        ...
        case SMALLER_EXTREME_HILLS:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "forest.chance", .01, false) * hero.getLevel(this);
        ...
        case SWAMPLAND:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "swamp.chance", .01, false) * hero.getLevel(this);
        ...
        case PLAINS:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "plains.chance", .01, false) * hero.getLevel(this);
        ...
        case DESERT_HILLS:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "desert.chance", .005, false) * hero.getLevel(this);
        ...
        case BEACHES:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "water.chance", .01, false) * hero.getLevel(this);
        ...
        case MUSHROOM_ISLAND:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "mushroom.chance", .01, false) * hero.getLevel(this);
        ...
        case HELL:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "hell.chance", .005, false) * hero.getLevel(this);
        ...
        case SKY:
            ...
            chance = SkillConfigManager.getUseSetting(hero, this, "sky.chance", .01, false) * hero.getLevel(this);
