...
public class TotemEffect extends PeriodicExpirableEffect {
    ...
    private com.herocraftonline.heroes.characters.skill.skills.totem.Totem totem;
    private boolean forcedExpire;
    
    public TotemEffect(SkillBaseTotem skill, com.herocraftonline.heroes.characters.skill.skills.totem.Totem totem, Player applier, long period, long duration) {
        this(skill, "TotemEffect", totem, applier, period, duration);
    }
    
    
    public TotemEffect(SkillBaseTotem skill, String name, com.herocraftonline.heroes.characters.skill.skills.totem.Totem totem, Player applier, long period, long duration) {
    ...
    public com.herocraftonline.heroes.characters.skill.skills.totem.Totem getTotem() {
        return totem;
    }
