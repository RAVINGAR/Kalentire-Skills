...
public class TotemListener implements Listener {
    ...
    public void onPluginDisable(PluginDisableEvent e) {
        ...
        Iterator<com.herocraftonline.heroes.characters.skill.skills.totem.Totem> iter = SkillBaseTotem.totems.iterator();
        while(iter.hasNext()) {
            com.herocraftonline.heroes.characters.skill.skills.totem.Totem totem = iter.next();
            totem.destroyTotem();
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        ...
        if(effect instanceof com.herocraftonline.heroes.characters.skill.skills.totem.TotemEffect) {
