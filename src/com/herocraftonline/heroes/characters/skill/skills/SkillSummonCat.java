...
public class SkillSummonCat extends ActiveSkill {
    ...
    public SkillResult use(Hero hero, String[] args) {
        ...
        hero.getPlayer().getWorld().playSound(hero.getPlayer().getLocation(), CompatSound.ENTITY_CAT_PURREOW.value(), 0.8F, 1.0F);
