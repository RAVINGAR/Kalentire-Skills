    ...
    public class SkillEntityListener implements Listener {
        ...
        public void onEntityDamage(EntityDamageEvent event) {
            ...
            if (dmger instanceof Player) {
                ...
                target.getWorld().spigot().playEffect(target.getEyeLocation(), Effect.TILE_BREAK, org.bukkit.Material.ICE.getId(), 0, 0.2F, 0.2F, 0.2F, 0.1F, 16, 16);
                target.getWorld().playSound(target.getLocation(), Sound.GLASS, 7.0F, 16);
