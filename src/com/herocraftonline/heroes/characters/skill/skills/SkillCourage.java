...
public class SkillCourage extends TargettedSkill {
    ...
    public SkillCourage(Heroes plugin) {
        ...
        setTypes(SkillType.MAX_HEALTH_INCREASING, SkillType.ABILITY_PROPERTY_MAGICAL, SkillType.BUFFING, SkillType.SILENCABLE);
    }
    ...
    public void init() {
        ...
        applyText = SkillConfigManager.getRaw(this, SkillSetting.APPLY_TEXT, Messaging.getSkillDenoter() + "$1 is encouraged and has Courage!");
        expireText = SkillConfigManager.getRaw(this, SkillSetting.EXPIRE_TEXT, Messaging.getSkillDenoter() + "$1 goes back to being discouraged.");
    }
