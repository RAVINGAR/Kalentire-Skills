    ...
    public class SkillEntityListener implements Listener {
        ...
        public void onEntityShootBow(EntityShootBowEvent event) {
            ...
            if (hero.hasEffect("AimedShotBuffEffect")) {
                ...
                player.getWorld().playSound(player.getLocation(), Sound.ENTITY_WOLF_HOWL.value(), 0.7f, 1.0F);
                target.getWorld().playSound(target.getLocation(), Sound.ENTITY_WOLF_HOWL.value(), 0.7f, 1.0F);
