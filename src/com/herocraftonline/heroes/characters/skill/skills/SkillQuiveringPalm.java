...
public class SkillQuiveringPalm extends TargettedSkill {
	...
	public ConfigurationSection getDefaultConfig() {
		...
		node.set(SkillSetting.APPLY_TEXT.node(), "�7[�2Skill�7] %target% is weakened by a �lQuiveringPalm!");
		node.set(SkillSetting.EXPIRE_TEXT.node(), "�7[�2Skill�7] %target% has recovered from the effects of the �lQuiveringPalm!");
	...
	public String getDescription(Hero hero) {
		...
		double duration = SkillConfigManager.getUseSetting(hero, this, SkillSetting.DURATION, 2500, false) / 1000;
		double damageMultiplier = (int) ((SkillConfigManager.getUseSetting(hero, this, "damage-multiplier", 1.2, false) - 1) * 100);
