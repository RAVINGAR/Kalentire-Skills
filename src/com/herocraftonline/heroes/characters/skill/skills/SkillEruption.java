...
public class SkillEruption extends ActiveSkill {
    ...
    public SkillEruption(Heroes plugin) {
        ...
        setTypes(SkillType.DAMAGING, SkillType.ABILITY_PROPERTY_MAGICAL, SkillType.ABILITY_PROPERTY_FIRE, SkillType.AGGRESSIVE);
    }
    ...
    private class EruptionEffect extends Effect {
        ...
        public EruptionEffect(EffectManager manager) {
            super(manager);
        ...
        public void onRun() {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                display(lavaDripParticle, loc2, 0, 2);
            }
            for (int a = 0; a < 100; a++)
