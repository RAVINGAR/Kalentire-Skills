...
public class SkillUppercut extends TargettedSkill {

    public SkillUppercut(Heroes plugin) {
        super(plugin, "Uppercut");
        setDescription("Uppercut towards your target and deal $1 damage! Targeting distance for this ability is increased by your Dexterity.");
        setUsage("/skill uppercut");
        setArgumentRange(0, 0);
        setIdentifiers("skill uppercut");
    ...
    public SkillResult use(final Hero hero, final LivingEntity target, String[] args) {
        ...
        player.getWorld().spigot().playEffect(player.getLocation(), Effect.SMOKE, 0, 0, 0, 0.1F, 0, 0.5F, 25, 12);
        player.getWorld().spigot().playEffect(target.getLocation().add(0, 0.5, 0), Effect.CRIT, 0, 0, 0, 0, 0, 1, 25, 16);
