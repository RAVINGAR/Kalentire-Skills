...
public class SkillBruteForce extends TargettedSkill {
    ...
    public SkillBruteForce(Heroes plugin) {
        ...
        setTypes(SkillType.ABILITY_PROPERTY_PHYSICAL, SkillType.ABILITY_PROPERTY_MAGICAL, SkillType.BUFFING, SkillType.SILENCABLE);
    }
    ...
    public void init() {
        ...
        applyText = SkillConfigManager.getRaw(this, SkillSetting.APPLY_TEXT, Messaging.getSkillDenoter() + "$1 is willing to use Brute Force!");
        expireText = SkillConfigManager.getRaw(this, SkillSetting.EXPIRE_TEXT, Messaging.getSkillDenoter() + "$1 is no longer using Brute Force.");
    }
