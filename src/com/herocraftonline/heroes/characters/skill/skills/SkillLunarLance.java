...
public class SkillLunarLance extends TargettedSkill {
	...
	private final int defDamage = 110;																	// Default damage
	private final int defBurnValue = 20;																// Default mana burn amount
	private final String defFailText = ChatColor.WHITE + "You need a shovel to use this ability!";		// Default skill fail text
	...
	public SkillLunarLance(Heroes plugin) {
		...
		setTypes(SkillType.DAMAGING, SkillType.PHYSICAL, SkillType.MANA, SkillType.HARMFUL);
	}
	...
	{
		// Make sure we have a player for the target
