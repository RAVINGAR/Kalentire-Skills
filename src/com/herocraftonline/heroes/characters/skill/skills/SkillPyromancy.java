...
public class SkillPyromancy extends ActiveSkill implements Listener {
    ...
    public SkillPyromancy(final Heroes plugin) {
        ...
        plugin.getServer().getScheduler().runTask(plugin, new Runnable() {
            ...
            @Override
            public void run() {
                EntityUtil_v1_12_R1.registerCustomEntity(PyromancyBlaze.class, "SkillPyromancyBlaze", 61, false);
                EntityUtil_v1_12_R1.registerCustomEntity(PyromancyBlazeFireball.class, "SkillPyromancyFireball", 12, false);
            }
