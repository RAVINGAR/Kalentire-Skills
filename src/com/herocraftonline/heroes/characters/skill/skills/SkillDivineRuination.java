...
public class SkillDivineRuination extends SkillBaseBlockWave {
	...
	public SkillDivineRuination(Heroes plugin) {
		...
		setDescription("The purging quake erupts and throws blocks around hitting all targets in a $1 degree arc in front of you, with a radius of $2, height of $3, and depth of $4, " +
	...
	public SkillResult use(final Hero hero, String[] strings) {
		...
		new BukkitRunnable() {
			...
			@Override
			public void run() {
				world.playSound(hero.getPlayer().getLocation(), Sound.ENTITY_FIREWORK_BLAST.value(), volume, 1f);
				volume -= 0.1;
