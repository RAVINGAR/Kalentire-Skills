...
public class SkillEarthernFury extends TargettedSkill {
    ...
    public void init() {
        ...
        applyText = SkillConfigManager.getRaw(this, SkillSetting.APPLY_TEXT, Messaging.getSkillDenoter() + "%target% feels the earthern fury of %hero%!").replace("%target%", "$1").replace("%hero%", "$2");
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
         ...
         * */
        player.getWorld().spigot().playEffect(target.getLocation().add(0, 1.0, 0), org.bukkit.Effect.TILE_BREAK, 3, 0, 0, 0, 0, 1, 25, 16);
