...
public class SkillSmelt extends ActiveSkill{
	...
	public final ConfigurationSection getDefaultConfig(){
		...
		config.set(base, 20);
		config.set(gain,  0.5f);//max possible price per ingot is 11c at level 60, using defaults
		return config;
	}
}
