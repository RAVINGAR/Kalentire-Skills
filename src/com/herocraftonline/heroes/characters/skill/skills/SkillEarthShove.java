...
public class SkillEarthShove extends TargettedSkill {
    ...
    public SkillEarthShove(Heroes plugin) {
        super(plugin, "Earthshove");
        setDescription("Use loose earth around your target to deal $1 damage and shove your target away from you. The power of the shove is affected by your Intellect.");
        setUsage("/skill earthshove");
        setArgumentRange(0, 0);
        setIdentifiers("skill earthshove");
