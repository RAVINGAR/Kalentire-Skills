...
public class SkillCannon extends ActiveSkill {

    public SkillCannon(Heroes plugin) {
        super(plugin, "Cannon");
        setDescription("Throwns $1 primed TNT that does not harm entities but can most break blocks.");
        setUsage("/skill cannon");
        setArgumentRange(0, 0);
        setIdentifiers("skill cannon");
