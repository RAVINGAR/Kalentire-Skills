...
/*
  Improved version of Fireball, which stores the damage  and fireball attributes with the fireball,
  rather then grabbing on collision. This allows the modification for a fireball scroll from Heroes Scrolls to work.
  Created (before) 16th Nov 2019 By MysticMight
 */
    ...
    public class SkillEntityListener implements Listener {
        ...
        public void onEntityDamage(EntityDamageEvent event) {
            ...
            if (dmger instanceof Player) {
                ...
                //before particle:  targetLE.getWorld().playEffect(targetLE.getLocation().add(0, 0.5F, 0), Effect.FLAME, 0, 0, 0.2F, 0.2F, 0.2F, 0.1F, 50, 16);
                targetLE.getWorld().spawnParticle(Particle.FLAME, targetLE.getLocation().add(0, 0.5F, 0),50,0.2F,0.2F,0.2F,0.1F);
