...
public class SkillEarthGrab extends TargettedSkill {

    public SkillEarthGrab(Heroes plugin) {
        super(plugin, "Earthgrab");
        setDescription("Grab your target with earth, dealing $1 damage and pulling them towards you. The targeting distance of this ability is affected by your Intellect.");
        setUsage("/skill earthgrab");
        setArgumentRange(0, 0);
        setIdentifiers("skill earthgrab");
