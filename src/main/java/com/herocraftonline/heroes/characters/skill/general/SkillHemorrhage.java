...
import com.herocraftonline.heroes.characters.skill.general.SkillHook.InvalidHookTargetReason;
...
public class SkillHemorrhage extends TargettedSkill {
    ...
    public SkillResult use(Hero hero, LivingEntity target, String[] args) {
        ...
        InvalidHookTargetReason invalidHookTargetReason = SkillHook.tryRemoveHook(plugin, hero, target);
