...
public class SkillCamouflage extends ActiveSkill {
    ...
    private final CamoMoveChecker moveChecker;
    private static final Set<Material> allowedMaterials = EnumSet.noneOf(Material.class);

    static {
        allowedMaterials.add(Material.DIRT);
        allowedMaterials.add(Material.COARSE_DIRT);
        allowedMaterials.add(Material.ROOTED_DIRT);
        allowedMaterials.add(Material.DIRT_PATH);
    ...
    public static class CamoMoveChecker implements Runnable {
